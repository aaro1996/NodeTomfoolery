...
my_script.div_chatlog = document.getElementById("div_chatlog"),
my_script.button_send_message = document.getElementById("button_send_message"),
my_script.input_text_message = document.getElementById("input_text_message")
...
function send_message(msg){
   socketio.emit("send_message", {message:msg});
}
